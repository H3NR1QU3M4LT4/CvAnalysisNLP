...
from .connect_all_nodes import connect_edge_target_all_nodes
...
def edge_index_target_all_connected(document_page):
    nodes = []
    edges = []
    convert_line_id_to_id_node = {}
    for idx, line in enumerate([
    ...
    for line in document_page.lines:
        if line.label == label_name["WORK_EXPERIENCE"]:
            connect_edge_target_all_nodes(document_page.lines, line, convert_line_id_to_id_node, nodes, edges)
